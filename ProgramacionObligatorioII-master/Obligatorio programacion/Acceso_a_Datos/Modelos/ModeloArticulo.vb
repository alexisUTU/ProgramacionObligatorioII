...
Public Class ModeloArticulo
    ...
    Private Shared instancia As ModeloArticulo
    ...
    Public Function SeleccionarArticulo(id As Integer) As DataTable
        ...
        Dim consulta As String = "SELECT * FROM ARTICULOS WHERE id_articulo=?"

        Dim parametros As New List(Of MySqlParameter)
        parametros.Add(New MySqlParameter("id_articulo", id))
        Return ConsultasBase.Singleton.ConsultaTabla(parametros, consulta)

    End Function

#Region "version vieja"

    'Public Function enlistarArticulo(id As Integer) As Boolean
    '    Dim consulta As String = "CALL agregarAListaDeCompra(@id)"
    ...
    '    Dim consulta As String = "CALL cancelarCompra"
    '    Dim parametros As New List(Of MySqlParameter)
    '    If ConsultasBase.Singleton.consultaInsert(parametros, consulta) Then
    '        Return True
    '    End If
